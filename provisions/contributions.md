...
* within the GC.OS governance framework
...
* writing minutes in one of the GC.OS committee meetings
...
* participating in 3 mentoring meetings as co-mentor, in one of the GC.OS mentoring or internship programmes.
...
* donating the monetary equivalent of 10 hours median working wage of one's country of residence,
  or one's own wage, whichever lower, to an GC.OS charitable account.
...
* running one of the GC.OS mentoring or internship programmes for one full period (e.g., summer)
* taking on mentorship for a junior community member for at least 9 meetings, in one of the GC.OS mentoring or internship programmes
